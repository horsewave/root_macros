...
void Image_merge_Ge_phantom()
{


  //input with scatter correction
  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/random_OFOV/Random-OFOV-activity-C11-2016-09-08/XB1BN286N-BI-01/img/";
  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Random-OFOV-activity-C11-2016-09-08/XB1BN286N-BI-02/img/";
  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Random-OFOV-activity-C11-2016-09-08/XB1BN286N-BI-03/img/";
  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Random-OFOV-activity-C11-2016-09-08/XB1BN286N-BI-04/img/";
  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Random-OFOV-activity-C11-2016-09-08/XB1BN286N-BI-05/img/";
  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Random-OFOV-activity-C11-2016-09-08/XB1BN286N-BI-06/img/";
  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Random-OFOV-activity-C11-2016-09-08/XB1BN286N-BI-07/img/";
  string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Random-OFOV-activity-C11-2016-09-08/XB1BN286N-BI-08/img/";

    
  //string input_image_att="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Random-OFOV-activity-C11-2016-09-08/common_files/atten/XB1BN286N_AttenMap_HeadOnly_3_fov.i";
  string input_image_att="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Random-OFOV-activity-C11-2016-09-08/XB1BN286N-BI-01/img/range_0-1223_reco_W3_na_3_ofov.dat";
  ...
  string output_image=base_folder+patient_name_output;
  string input_image_emi=input_image_att;
  
  output_image=output_image;

  float threshold_att=10;
  ...
  input_image_emi=input_image_att;
  output_image=output_image;
 ...
 //float C11_activity=112.41;//frame_01
  //float C11_activity=56.2;//frame_02
  //float C11_activity=28.1;//frame_03
  //float C11_activity=14.05;//frame_04
  //float C11_activity=7.03;//frame_05
  //float C11_activity=3.51;//frame_06
  //float C11_activity=1.74;//frame_07
  float C11_activity=0.87;//frame_08
 
  Set_img_value(input_image_emi,input_image_att,output_image,C11_activity,threshold_att);
...
void Set_img_value_C11_phantom(string input_image_emi,string input_image_att,string output_image,float C11_activity)
{
  ...
  void Set_img_value(string input_image_emi,string input_image_att,string output_image,float C11_activity,float threshold_att)
{
