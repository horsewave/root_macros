...
void Image_merge_sphere_phantom()
{


  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/XB1BN305N-BI/atten/att_realistic/XB1BN305N-BI-01_02/";
  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/XB1BN305N-BI/atten/att_realistic/XB1BN305N-BI-03_04/";
  //string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/XB1BN310N-BI/atten/att_realistic/XB1BN310N-BI-01_02/";
  string base_folder="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/XB1BN310N-BI/atten/att_realistic/XB1BN310N-BI-03_04/";

  string patient_name_input_IFOV="mr_image_registered_to_pet.i";
  string patient_name_input_OFOV="mr_image_registered_to_pet.i";
  //string patient_name_input="XB1BN305N-BI-01_1_fov_att_map.i";
  //string patient_name_input="mr_image_registered_to_pet_01_02.i";
  string patient_name_output="XB1BN305N-BI-01_2_fov_att_map_only_sphere_phantom.i";
...
//    XB1BN310N-BI-03-04_1_fov_att_map.i
  //1: merge two Fov

  string input_image_IFOV= base_folder +patient_name_input_IFOV;
  string input_image_OFOV=base_folder +patient_name_input_OFOV;

  string output_image=base_folder +"mr_merge_2_fov.i";
  
  Image_merge_sphere_phantom( input_image_IFOV,input_image_OFOV, output_image);
  
  //2: merge to three fov
  //
  //
  //string input_img_3_ofov=output_image;
  //string output_image_2_fov=base_folder +"XB1BN305N-BI-01-02_1_fov_att_map_OFOV.i";
  //Extract_OFOV_img(input_img_3_ofov, output_image_2_fov);

 input_image_OFOV=output_image;
 output_image=base_folder +"mr_merge_3_fov.i";
 
  Image_merge_sphere_phantom_tri_fov( input_image_IFOV,input_image_OFOV, output_image);
  //
...
void Image_merge_sphere_phantom( string input_image_IFOV,string input_image_OFOV, string output_image)
{
...
void Extract_OFOV_img(string input_img_3_ofov, string output_image_2_fov)
{
  ...
  Read_image(input_img_3_ofov,  image_merge, dimx_merge, dimy_merge, dimz_merge);


   //add the head data to the OFOV data.
  for(int z =dimz_IFOV ; z <dimz_merge;z++){
    ...
    for(int y = 0; y < dimy_OFOV ; y++){
      ...
      for(int x = 0; x < dimx_OFOV; x++){
        int img_merge_index =z_index_temp+y_index_temp+x;
          ...
          int img_ofov_index=img_merge_index-(dimz_IFOV*dimy_IFOV*dimx_IFOV);
          image_OFOV[img_ofov_index]=image_merge[img_merge_index];
  ...
  Save_image(output_image_2_fov, image_OFOV, dimx_OFOV, dimy_OFOV,dimz_OFOV );
...
void Image_merge_sphere_phantom_tri_fov( string input_image_IFOV,string input_image_OFOV, string output_image)
{
