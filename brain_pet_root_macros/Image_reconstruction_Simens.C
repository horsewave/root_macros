...
void Image_reconstruction_Simens()
{
  ...
  ////float formats:
 /* string prompt_sino="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/sphere_phantom_simu/1_fov/scatterMCS/run_5000_with_detector_modual/true_plus_scatter.fs";*/
  ...
  //string atte_sino= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/XB1BN305N-BI/XB1BN305N-BI-01/atten/AttenMap_for_reco.a";//float format

  //// scatter with scatter modual;
  //string scatter_sino_scaled = "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/sphere_phantom_simu/1_fov/scatterMCS/run_5000_with_detector_modual/scatter_normed.fs";
  //// scatter file: with detetion module; norm: with detector modual
  //string reconstructe_img= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/sphere_phantom_simu/1_fov/scatterMCS/img/with_detec_modual/recon_img_scat_sino_with_detec_with_norm_norm_sino_with_detect_1.i";
  ...
  //reconstructe_img= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/sphere_phantom_simu/1_fov/scatterMCS/img/no_detec_modual/recon_img_scat_sino_no_detec_with_norm_norm_sino_with_detect.i";
  ...
  /*////// ******************** 4: with detector modual,using the true sino only**************************/
   ...
   string prompt_sino="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/sphere_phantom_simu/1_fov/scatterMCS/run_5000_with_detector_modual/true.fs";
  string random_sino="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/cylinder_phantom_norm_file_mcs/common_sino_files/random.fs";

  //--- Norm file for measurement data
  //string norm_sino= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/cylinder_phantom_norm_file_mcs/norm_with_detection_modual/norm_sino_320_192_with_detection_modual.fs";
  string norm_sino= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/cylinder_phantom_norm_file_mcs/norm_with_detection_modual/norm_sino_320_192_normed_to_one.fs";
  ...
  string scatter_sino_scaled = "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/cylinder_phantom_norm_file_mcs/common_sino_files/scatter.fs";
  // scatter file: with detetion module; norm: with detector modual
  string reconstructe_img= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/sphere_phantom_simu/1_fov/scatterMCS/run_5000_with_detector_modual/true_it_32_2.i";
