...
void Image_reconstruction_Simens()
{
  ...
  //string prompt_sino="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Brain_phantom_ma/gpu_mcs/scatterMCS/merged/true.fs";
  string prompt_sino="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Brain_phantom_ma/gpu_mcs/scatterMCS/merged/scatter.fs";
  //string prompt_sino="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/cylinder_phantom_norm_file_mcs/scatterMCS/with_detection_modual/merged_sino/norm_acq_gpuSimu_0_true.fs";
  ...
  string norm_sino= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/cylinder_phantom_norm_for_scatter_recon/scatterMCS/merged/norm_sino_for_scatter.fs";
  ...
  //string atte_sino= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/cylinder_phantom_norm_file_mcs/common_sino_files/norm_ones_with_gaps.fs";//float format
  string atte_sino= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Brain_phantom_ma/gpu_mcs/att_fwp.fs";//float format
  ...
  //string reconstructe_img= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/cylinder_phantom_norm_file_mcs/scatterMCS/with_detection_modual/merged_sino/img_recon.i";
  string reconstructe_img= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/Brain_phantom_ma/gpu_mcs/scatterMCS/merged/img_recon_scatter_norm_for_scatter.i";
