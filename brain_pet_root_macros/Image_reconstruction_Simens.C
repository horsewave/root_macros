...
void Image_reconstruction_Simens()
{
  ...
  string prompt_sino="/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/sphere_phantom_simu/1_fov_305/scatterMCS/merged_with_detector_modual/true.fs";
  ...
  string atte_sino= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/sphere_phantom_simu/1_fov_305/att_fwp_with_gaps.fs";//float format
  ...
  //string scatter_sino_scaled = "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/XB1BN310N-BI/XB1BN310N-BI-01/scatterMCS/run_num_4000_with_detect/scatter_scaled_normed_with_true_plus_scatter_with_coil.fs";
  ...
  string reconstructe_img= "/data/PET/mr_pet_temp/Ma/software/data/gpupet/phantom/sphere_phantom_simu/1_fov_305/scatterMCS/merged_with_detector_modual/true_with_att_fwd.i";
