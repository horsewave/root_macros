...
void rc_real_region()
{
 ...
 path_img_voi= path_base_folder + "voi_img/img_voi_real_region_22mm.i" ;
 sphere_name ="22mm real region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );

 path_img_voi= path_base_folder + "voi_img/img_voi_real_region_17mm.i" ;
 sphere_name ="17mm real region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );

path_img_voi= path_base_folder + "voi_img/img_voi_real_region_13mm.i" ;
 sphere_name ="13mm real region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );

 path_img_voi= path_base_folder + "voi_img/img_voi_real_region_10mm.i" ;
 sphere_name ="10mm real region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );

 path_img_voi= path_base_folder + "voi_img/img_voi_real_region_8mm.i" ;
 sphere_name ="8mm real region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );

}

void rc_effect_region()
{
  ...
  string path_img_voi= path_base_folder + "voi_img/img_voi_effect_region_27mm.i" ;
  string sphere_name ="27mm effect region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );



 path_img_voi= path_base_folder + "voi_img/img_voi_effect_region_22mm.i" ;
 sphere_name ="22mm effect region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );

 path_img_voi= path_base_folder + "voi_img/img_voi_effect_region_17mm.i" ;
 sphere_name ="17mm effect region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );

path_img_voi= path_base_folder + "voi_img/img_voi_effect_region_13mm.i" ;
 sphere_name ="13mm effect region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );

 path_img_voi= path_base_folder + "voi_img/img_voi_effect_region_10mm.i" ;
 sphere_name ="10mm effect region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );

 path_img_voi= path_base_folder + "voi_img/img_voi_effect_region_8mm.i" ;
 sphere_name ="8mm effect region";
 get_rc_single_sphere(path_img_data, path_img_voi,saved_data_path ,sphere_name );
