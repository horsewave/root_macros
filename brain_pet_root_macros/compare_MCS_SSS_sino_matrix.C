...
//void compare_MCS_SSS_sino_matrix(int view_index)
{
  ...
  string part_name_mcs="scatterMCS/run_num_200/XB1BN310N-BI-01_0-1800_gpuSimu_scattersino_scaled.fs";
  string part_name_sss="scatterMCS/run_num_5000/XB1BN310N-BI-01_0-1800_gpuSimu_scattersino_scaled.fs";
...
/////////////running without input parameters//////////////////////////////////////////////////
  ...
  TMatrix* mat_sss= new TMatrix(dimx,dimy);
   ...
   //draw the sino matrix
   string can_name_mcs="canvas_sino_mcs";
   string can_name_sss="canvas_sino_sss";
