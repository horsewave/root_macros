...
const int mcs_num=2;
void compare_MCS_SSS_sino_radial_mult_run()
{
...
//for(int i=0;i<vector_size;i++)
  //{
    //if(vector_events_radial_mcs[j][i]==0)
    //{
      ...
      //vector_events_radial_mcs[j][i]=vector_events_radial_sss[i]-vector_events_radial_sss[i]*0.83;
